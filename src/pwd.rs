...
use crate::{
    lang::{MESSAGE_LOGO, MESSAGE_VERT},
    pathutil::is_mounted_win_path,
};
...
pub fn exec() {
    ...
    match pwd {
            ...
            match wsl_to_windows(&pwd) {
                ...
                Err(e) => {
                    eprintln!(
                        "{}{}",
                        *MESSAGE_LOGO,
                        "Found Windows paths, but Unable to convert it."
                            .red()
                            .bold()
                    );
        ...
        _ => {
            eprintln!(
                "{}",
                "[wsl-dirutils] Unable to get current directory.".red()
            );
            exit(1);
        }
    }
